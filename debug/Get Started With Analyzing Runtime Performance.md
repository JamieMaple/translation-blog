...
在这个教程中，你应该在打开一个页面同时使用性能分析面板来找到当前页面的性能瓶颈。
...
最后，有非常多的方式来对运行时的性能进行优化。这个教程只是针对一个比较特定的动画瓶颈，来让你重点浏览 Performance 面板，但是这仅仅是许多你应该考虑瓶颈中的一个。剩下一些列的 Rendering Performance 还有更多好的提示，让你对其他非常多方面提升运行时性能，比如：
